...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    ['protocol_header', 'protocol_badge_police', 'protocol_tape_meta', 'protocol_paper_dossier', 'protocol_paper_stats', 'protocol_stamp_shame', 'protocol_stamp_shame_1', 'protocol_plate_id', 'protocol_plate_rusty', 'protocol_stamp_skull', 'portrait_vypolzok_flattened', 'portrait_vypolzok_eye', 'portrait_vypolzok_win', 'portrait_markovka_win', 'portrait_markovka_beaten', 'portrait_markovka_eye'].forEach(k => this.load.image(k, `/assets/ui/gameover/${k}.webp`));
